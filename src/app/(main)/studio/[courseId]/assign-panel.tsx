        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
          ...
          <label className="flex flex-col gap-y-1">
            ...
            <input
              ...
              className="rounded-xl border-2 px-3 py-1.5 text-sm outline-none focus:border-brand disabled:opacity-50"
            />
          </label>
          ...
          {current.map((row) => (
            ...
            >
              <span className="text-sm font-medium text-ink">
                {row.targetLabel}
                {row.required ? (
                  <span className="ml-2 rounded-full bg-gold-50 px-2 py-0.5 text-xs font-bold text-gold-700">
                    Required
                  </span>
                ) : (
                  <span className="ml-2 rounded-full bg-canvas-2 px-2 py-0.5 text-xs font-bold text-ink-3">
                    Optional
                  </span>
                )}
                {row.dueDate && (
