  ...
  return (
    <section className="mb-4 rounded-2xl border-2">
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        title="Publish this course to the shared course library"
        className="flex w-full items-center justify-between gap-x-3 px-4 py-3 text-left"
      >
        <span className="flex items-center gap-x-2">
          <Store className="h-[18px] w-[18px] text-ink-3" strokeWidth={1.8} />
          <span className="text-sm font-bold text-ink">Marketplace</span>
          {listing && (
            <span
              className={
                listed
