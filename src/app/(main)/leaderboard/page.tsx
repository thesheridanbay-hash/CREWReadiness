    ...
    <div className="flex flex-row-reverse gap-[48px] px-6">
      ...
      <FeedWrapper>
        <div className="flex w-full flex-col items-center">
          ...
          <h1 className="my-6 text-center text-2xl font-bold text-ink">
            Leaderboard
          </h1>
          <p className="mb-6 text-center text-lg text-muted-foreground">
            See where you stand among your crew.
          </p>
          ...
          {leaderboard.map((userProgress, i) => (
            ...
            >
              <p className="mr-4 font-bold text-success-700">{i + 1}</p>

              <Avatar className="ml-3 mr-6 h-12 w-12 border bg-brand">
                <AvatarImage
              ...
              <p className="flex-1 font-bold text-ink">
