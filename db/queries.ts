...
/**
 * NOTE (T1/D14): this module is replaced by the tenant-scoped query layer
 * (lib/db/scoped.ts + RLS) in T1. Until then, queries are single-tenant and
 * authenticated via the temporary session stub.
 */
      ...
      lessons: {
        ...
        with: {
          challenges: {
            ...
            with: {
              challengeProgress: {
                where: eq(challengeProgress.userId, session.userId),
              },
            },
          },
        },
